    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker : IDisposable
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                misc.Add("HoldPosRadius", new Slider("Hold Position Radius", 50, 0, 250));
                ...
                /* Delay sliders */
                _config.Add("ExtraWindup", new Slider("Extra windup time", 35, 0, 200));
                _config.Add("FarmDelay", new Slider("Farm delay", 0, 0 , 200));
                /*Load the menu*/
                _config.Add("Flee", new KeyBind("Flee", false, KeyBind.BindTypes.HoldActive));
                _config.Add("LastHit", new KeyBind("Last Hit", false, KeyBind.BindTypes.HoldActive));
                _config.Add("Farm", new KeyBind("Mixed", false, KeyBind.BindTypes.HoldActive));
                _config.Add("LaneClear", new KeyBind("LaneClear", false, KeyBind.BindTypes.HoldActive));
                _config.Add("Orbwalk", new KeyBind("Combo", false, KeyBind.BindTypes.HoldActive));
                _config.Add("Burst", new KeyBind("Burst", false, KeyBind.BindTypes.HoldActive));
                _config.Add("FastHarass", new KeyBind("Fast Harass", false, KeyBind.BindTypes.HoldActive));
                _config.Add("StillCombo", new KeyBind("Combo without moving", false, KeyBind.BindTypes.HoldActive));
