...
namespace Evade
{
    ...
    internal class EvadeSpellData
    {
        ...
        public int DangerLevel
        {
            get
            {
                if (Config.skillShots["DangerLevel" + Name] != null)
                {
                    return Config.skillShots["DangerLevel" + Name].Cast<Slider>().CurrentValue;
                }
                return _dangerLevel;
            }
        }
        ...
        public bool Enabled
        {
            get
            {
                if (Config.skillShots["Enabled" + Name] != null)
                {
                    return Config.skillShots["Enabled" + Name].Cast<CheckBox>().CurrentValue;
                }
                return true;
            }
        }
