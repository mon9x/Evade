    ...
    public static class Geometry
    {
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = SharpGeometry.CircleCircleIntersection(Start, End, innerRadius, innerRadius);
                var outerCenters = SharpGeometry.CircleCircleIntersection(Start, End, outerRadius, outerRadius);
